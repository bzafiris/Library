...
public class BookTest {
	...
	@Test
	public void denyReservation_onBookWithAvailableItems() {

		Borrower borrower = new Borrower();

		Reservation r = book.reserveFor(borrower);
	...
	@Test
	public void denyReservation_onItsBorrower() {
		Borrower borrower = new Borrower();
		BorrowerCategory category = new BorrowerCategory("", 10, 10, null);
	...
	@Test
	public void allowReservation_on() {
